...
<head>
  ...
  <link rel="stylesheet" href="${root}styles.css?v=13">
  <script src="${root}content.js?v=13" defer></script>
  <script src="${root}map-config.js?v=13" defer></script>
  <script src="${root}app.js?v=13" defer></script>
</head>
